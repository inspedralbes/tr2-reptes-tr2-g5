...
<template>
  <v-container class="admin-wrapper pa-10" fluid>
    <div class="d-flex justify-space-between align-start mb-8">
      <div class="d-flex align-center">
        ...
        <div>
          ...
          <p class="text-subtitle-1 text-grey-darken-1">Analitza el rendiment i satisfacció del programa ENGINY.</p>
        </div>
      </div>
    ...
    <v-row>
      <v-col cols="12" md="6">
        <v-card variant="flat" class="pa-6 border-consorci bg-white">
          ...
          <div class="bg-grey-lighten-4 py-10 rounded d-flex align-end justify-center" style="height: 200px; gap: 10px;">
             <div style="width: 40px; height: 80%; background-color: black;"></div>
             <div style="width: 40px; height: 60%; background-color: #666;"></div>
             <div style="width: 40px; height: 90%; background-color: black;"></div>
          </div>
        </v-card>
      </v-col>
      <v-col cols="12" md="6">
        <v-card variant="flat" class="pa-6 border-consorci bg-white">
          ...
          <div class="bg-grey-lighten-4 py-10 rounded d-flex flex-column align-center justify-center">
            <span class="text-h2 font-weight-bold">94.2%</span>
            <v-icon size="40" class="mt-2">mdi-trending-up</v-icon>
          </div>
        </v-card>
      </v-col>
    </v-row>
